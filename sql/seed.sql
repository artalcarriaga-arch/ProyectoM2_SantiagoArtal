-- ============================================
-- MINIBLOG API - Seed Data
-- ============================================
-- Datos de prueba para desarrollar/testear la API

-- Limpiar datos existentes (CUIDADO: elimina todo)
-- DELETE FROM posts;
-- DELETE FROM authors;
...
-- ============================================
-- Posts del author_id = 1 (Juan García)
...
-- Posts del author_id = 2 (María López)
INSERT INTO posts (author_id, title, content, published) VALUES
...
-- Posts del author_id = 3 (Carlos Rodríguez)
INSERT INTO posts (author_id, title, content, published) VALUES
